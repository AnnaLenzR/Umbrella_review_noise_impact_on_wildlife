...
fig1_A <- ggplot(quant_counts, aes(x = year, y = paper_count, fill = quant)) +
  ...
  labs(
    ...
    tag = "A"  # Add tag for Figure A here
  )+
  scale_y_continuous(
  limits = c(0, 12),
  breaks = seq(0, 12, 2)
...
## Patchwork plots- Figure 1—assemble thefull figure
```{r}
# Create panel pairs for better layout

fig1_AB <- (fig1_A | fig1_B) +
  plot_layout(nrow = 1) &
  theme(plot.tag = element_text(size = 14, face = "bold"))

fig1_CD <- (fig1_C | fig1_D) +
  plot_layout(nrow = 1) &
  theme(plot.tag = element_text(size = 14, face = "bold"))


# Create figure
fig1 <- fig1_AB / fig1_CD + 
  plot_layout(nrow = 2) & 
  theme(plot.tag = element_text(size = 14, face = "bold"))
...
fig1
#ggsave(here("Figures/raw", "figure_1.pdf"), width = 15, height = 10, dpi = 300)
#ggsave(here("Figures/raw", "figure_1.png"), width = 15, height = 10, dpi = 300)
...
fig6 
ggsave(here("Figures/raw", "Figure_6_CEESAT.pdf"), width = 15, height = 9, dpi= 300)
ggsave(here("Figures/raw", "Figure_6_CEESAT.png"), width = 15, height = 9, dpi = 300)
...
## Figure S5: Policy citation publication year of the REVIEW and the total policy citation
```{r}
...
fig_S5 <- ggplot(pol_cit, aes(x = year, y = unique_policy_citations)) +
  geom_jitter(size = 4.3, alpha = 0.25, color = "#8074A8FF", width = 0.3, height = 0) +
...
#Save
ggsave(here("Figures/raw", "Figure_S5_policyciting.pdf"), width = 10, height = 7, dpi = 300)
ggsave(here("Figures/raw", "Figure_S5_policyciting.png"), width = 10, height = 7, dpi = 300)
```
#¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬

# Figure S6: Policy trends
...
figS6_a <- ggplot(policytopic, aes(
  x = policy_year,,
  y    = n,
  fill = policy_topic
)) +
...
figS6 <- figS6_a + figS6_b + figS6_c + plot_layout(nrow = 3) + plot_annotation(tag_levels = "A")

#Show figure
figS6

# Save figure
ggsave(here("Figures/raw", "Figure_S6_trends.pdf"), width = 11, height = 12, dpi = 300)
ggsave(here("Figures/raw", "Figure_S6_trends.png"), width = 11, height = 12, dpi = 300)
...
```{r}
# Combine panels
fig_S8 <- fig_S8a + fig_S8b + plot_layout(nrow = 2) + plot_annotation(tag_levels = "A")

# Show figure
fig_S8

# Save figure
ggsave(here("Figures/raw", "Figure_S8_geographical_dist_policy.pdf"), width = 11, height = 8, dpi= 300)
ggsave(here("Figures/raw", "Figure_S8_geographical_dist_policy.png"), width = 11, height = 8, dpi = 300)
```
...
# To save the figure
ggsave(here("Figures/raw", "FigureS9_trends_syntheses_cited_not_cited.pdf"), width = 18, height = 15, dpi = 300)
ggsave(here("Figures/raw", "FigureS9_trends_syntheses_cited_not_cited.png"), width = 18, height = 15, dpi = 300)
